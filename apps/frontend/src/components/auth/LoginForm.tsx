      ...
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleTOTPSubmit} className="space-y-4">
            <div>
              <label className="block text-sm text-gray-500 mb-1">Authentication code</label>
              <input
                type="text"
                inputMode="numeric"
    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleCredentialsSubmit} className="space-y-4">
          <div>
            <label htmlFor="login-email" className="block text-sm text-gray-500 mb-1">
              Email
            </label>
            <input
              id="login-email"
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label htmlFor="login-password" className="text-sm text-gray-500">
                Password
              </label>
